  ...
  <div class="container">
    <div class="row">
      <div class="col-md-3 col-sm-3 footerleft ">
        <div class="logofooter text-center"> Logo</div>
        <p>Das ist ein Hammer Laden</p>
        <p><i class="fa fa-map-pin"></i> Adresse</p>
        <p><i class="fa fa-phone"></i> Telefon</p>
        <p><i class="fa fa-envelope"></i> E-mail : </p>
        
      </div>
      <div class="col-md-3 col-sm-6 paddingtop-bottom">
        <h6 class="heading7 text-center">Wichtige Links</h6>
        <ul class="footer-ul">
